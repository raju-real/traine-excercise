...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="{{ route('home') }}">Kegel Klock</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#team">Coach</a></li>
            ...
            <form action="{{ route('subscribe') }}" method="post" role="form" >
              ...
              <div class="row">
                <div class="col-md-8 form-group mt-3 mt-md-0">
                  <input type="email" class="form-control" name="email" id="email" placeholder="Your Email" required style="height: 70px;">
                </div>
                <div class="col-md-4 text-center">
                    <button type="submit" 
                    id="subscribe-button" 
                    style="background: #ef6603;
                        border: 0;
                        padding: 20px 48px;
                        color: #fff;
                        transition: 0.4s;
